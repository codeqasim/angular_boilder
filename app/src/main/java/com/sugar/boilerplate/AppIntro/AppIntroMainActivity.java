package com.sugar.boilerplate.AppIntro;
...
public class AppIntroMainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.intro_menu_main, menu);
        return true;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.footer_control_button_finish:
                startActivity(new Intent(AppIntroMainActivity.this,MainActivity.class));
                finish();
        }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView( LayoutInflater inflater,ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.intro_fragment_main, container, false);
