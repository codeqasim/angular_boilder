package com.sugar.boilerplate.SocialLogin;
...
public class SocailMainActivity extends AppCompatActivity implements SmartLoginCallbacks {
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick( View v ) {
                if (currentUser != null) {
                    ...
                    boolean result = smartLogin.logout(SocailMainActivity.this);

                    if (result) {

                        refreshLayout();

                        Toast.makeText(SocailMainActivity.this,"User logged out successfully",Toast.LENGTH_SHORT).show();
